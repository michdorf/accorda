import { c as create_ssr_component, a as subscribe, b as add_attribute, v as validate_component } from "../../chunks/index-c46f8c98.js";
import { p as page } from "../../chunks/stores-a971dd72.js";
var logo = "/chords/_app/assets/ikon-9bdf35c1.png";
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="${"svelte-t2wq17"}"><div class="${"corner svelte-t2wq17"}"><a href="${"https://dechiffre.dk"}" class="${"svelte-t2wq17"}"><img${add_attribute("src", logo, 0)} alt="${"SvelteKit"}" class="${"svelte-t2wq17"}"></a></div>
	...
	<nav class="${"svelte-t2wq17"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-t2wq17"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-t2wq17"}"></path></svg>
		<ul class="${"svelte-t2wq17"}"><li class="${["svelte-t2wq17", $page.url.pathname === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-t2wq17"}">Canzoni</a></li>
			<li class="${["svelte-t2wq17", $page.url.pathname === "/aggiungi" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/aggiungi"}" class="${"svelte-t2wq17"}">Aggiungi</a></li>
			</ul>
